...
// ▼  RIGHT LEG  ──────────────────────────────────────────────────────────────────────
    ...
    {  1,  "right_ankle_pitch",   142.0f,  +1,  -60.0f,  +60.0f,  180.0f,  706.0f  },  // TUNE
    ...
    {  5,  "right_hip_pitch",     127.0f,  +1,  -25.0f,  +90.0f,  270.0f,  545.0f  },  // TUNE

// ▼  LEFT LEG  ───────────────────────────────────────────────────────────────────────

    {  6,  "left_hip_pitch",      131.0f,  -1,  -25.0f,  +90.0f,  270.0f,  545.0f  },  // TUNE
...
// ▼  LEFT LEG (continued)  ───────────────────────────────────────────────────────────
    ...
    { 14,  "left_ankle_pitch",    122.0f,  -1,  -60.0f,  +60.0f,  180.0f,  706.0f  },  // TUNE
